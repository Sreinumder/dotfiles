...
alias dfia='dfi add'
alias dfiaa='dfia -A'
alias dfiaaa='dfiaa ~/.config/alacritty; dfiaa ~/.config/btop; dfiaa ~/.config/dunst; dfiaa ~/.config/firefox; dfiaa ~/.config/hypr; dfiaa ~/.config/lf; dfiaa ~/.config/nvim; dfiaa ~/.config/rofi; dfiaa ~/.config/lyrics-in-terminal; dfiaa ~/dotfiles; '
