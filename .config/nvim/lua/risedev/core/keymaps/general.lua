...
keymap.set({'n','v','o'}, "M", "gM", {desc = "Middle of Line"})
keymap.set({'n','v','o'}, "L", "$", {desc = "End of Line"})

keymap.set('n', "<A-H>", "H", {desc = "Highest line of screen"})
keymap.set('n', "<A-M>", "M", {desc = "Middle line of screen"})
keymap.set('n', "<A-L>", "L", {desc = "Lowest line of screen"})
